...
\begin{frame}
    \begin{itemize}
        ...
        \item Impacts include health, biogeochemical cycles, weather and climate, and atmospheric chemistry.
...
\begin{frame}
    ...
    \begin{block}{Smouldering Stage}
        \begin{itemize}
            ...
            \item Emits incompletely oxidised compounds: \ce{CO}, \ce{CH4}, non-methane hydrocarbons, PAHs, etc.
        \end{itemize}
    \end{block}
...
\begin{frame}
    ...
    \begin{block}{Field Study in SE Asia (Brunei for 1998 episode)}
        \begin{itemize}
            \item Monitored Criteria Pollutants: \textbf{\ce{PM_{10}}}, \ce{SO2}, \ce{NO2}, \ce{CO}, and \ce{O3}.
            \item Aerosol Size: >99\% of haze particles are \ce{PM_{2.5}}, making them "respirable" and highly hazardous to health.
...
\begin{frame}
    ...
    \begin{block}{Radical Generation}
        ...
        \[ \ce{O3 + h$\nu$ ->[H2O] O2 + 2OH${}^\cdot$} \tag{Hydroxyl}\]
        % \[ \ce{CO + OH${}^\cdot$ ->[O2] CO2 + HO2${}^\cdot$}  \tag{Hydroperoxyl}\]
        \[ \ce{H + O2 -> HO2${}^\cdot$ }  \tag{Hydroperoxyl}\]
    \end{block}
    ...
    \begin{block}{The Haze Paradox}
        \begin{itemize}
            ...
            \item By measurement, ground-level \ce{O3} often remains low despite high precursors.
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}
    \begin{block}{Greenhouse Gases}
        \begin{itemize}
            ...
            \item In the tropics, it is the largest contributor to global carbon emissions after fossil fuel combustion in industrialised countries.
        \end{itemize}
    \end{block}
...
\begin{frame}
    \begin{itemize}
        \item SE Asia haze is dominated by \ce{PM_{2.5}}, inhibited photochemistry, and neutralized rainwater acidity.
