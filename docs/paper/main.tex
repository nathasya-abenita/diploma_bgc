...
\begin{align*}
    ...
    (N_3, R_3) &= \left(\beta R_3, \frac{R_c (r' - \gamma E)}{a \beta R_c + r'} \right).
\end{align*}
...
We refer to $a$ also as deforestation or consumption rate. From Global Forest Watch dashboard, we can estimate the percentage change of tree cover in Sumba Island between 2000 and 2020. Approximately, $14\%$ of tree cover, especially in the west part of the island, was lost between that period time. 
